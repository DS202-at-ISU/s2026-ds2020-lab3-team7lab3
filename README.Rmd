...
"Out of 173 listed Avengers, my analysis found that 69 had died at least one time."
...
Based on the dataset, the number of Avengers who died at least once is approximately 69, which supports the statement made in the article.
...
> "on 57 occasions the individual made a comeback", "only a 50 percent chance they recovered from a second or third death."
...
- The dataset recorded that out of 89 total deaths, 57 Avengers made a return. My findings have directly verified the statement from the FiveThirtyEight analysis, with returns equaling 57. Also, my calculations estimate that there is a probability of 0.5 that an Avenger recovered from a second or third death, which is consistent with the statement made in the FiveThirtyEight analysis.
